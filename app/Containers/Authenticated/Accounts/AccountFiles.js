...
// Styless
import styles from './Styles/AccountFilesStyles'
...
class AccountFiles extends Component {
    ...
    componentDidMount() {
        setTimeout(() => {
            if (this.props.account && this.props.account.files) {
                this.setState({ dataSource: this.props.account.files ?? [] })
            }
        }, 100)
    }
    //Class Methods
...
export default connect(mapStateToProps)(AccountFiles);